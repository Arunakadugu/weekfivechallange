...
import me.aruna.weekfivechallange.Pet;
import me.aruna.weekfivechallange.PetRepository;
...
public class HomeController {
    ...
    @PostMapping("/process")
    public String processForm(@Valid Pet name, BindingResult result){
    ...
    @RequestMapping("/currentstatus/{id}")
    public String currentStatus(@PathVariable("id") Long id, Model model){
        model.addAttribute("pet", petRepository.findOne(id));
        return "show";
    }
}
